...
<script type="text/javascript">
		function topenModal(){
			...
			var tttile=$("#gtitleid").html();
			$("#title").val(tttile);
			
			var tdescription=$("#gdescriptionid").html();
			...
			<div class="wrap">
				...
				<div class="section group">
					<div class="grid_1_of_4 images_1_of_4">
						...
						<h4 id="gtitleid">Aenean nonummy hendrerit</h4>
						<p id="gdescriptionid">Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.
						</p>
							<a href="javascript:topenModal();"><img src="images/edit.png" style="height: 40px;"></a>
					...
					<div class="grid_1_of_4 images_1_of_4">
						...
						<p>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient.
							<a href="#"><img src="images/edit.png" style="height: 40px;"></a>
						</p>
						<a href="#" class="link">Read More</a>
					</div>
					<div class="grid_1_of_4 images_1_of_4">
  ...
  <div class="modal-dialog" style="width: 700px;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">EditGallery</h4>
      </div>
